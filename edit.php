    ...
    <div class="container">
        ...
        <form id="create-form" action="<?= $BASE_URL ?>config/process.php" method="post">
            ...
            <div class="form-group">
                <label for="name">Editar Nome:</label>
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control" id="observations" name="observations" placeholder="Observação" rows="3"><?= $contact['observations'] ?></textarea>
            </div>
